(function () {
    ...
    document.getElementById('alert-image').onclick = function () {
        Swal.fire({
            ...
            imageUrl: 'https://codeigniter.spruko.com/rixzo/rixzo/assets/images/media/media-59.jpg',
            imageWidth: 400,
            imageHeight: 200,
    ...
    document.getElementById('alert-custom-bg').onclick = function () {
        Swal.fire({
            ...
            padding: '3em',
            color: '#716add',
            background: 'url(https://codeigniter.spruko.com/rixzo/rixzo/assets/images/media/media-16.jpg)',
            backdrop: `
              rgba(0,0,0,0.3)
              url(https://codeigniter.spruko.com/rixzo/rixzo/assets/images/gif's/1.gif)
              left top
              no-repeat
            `
        })
    ...
    document.getElementById('alert-custom-success').onclick = function () {
        Swal.fire({
    ...
    document.getElementById('alert-custom-danger').onclick = function () {
        Swal.fire({
    ...
    document.getElementById('alert-custom-warning').onclick = function () {
        Swal.fire({
    ...
    document.getElementById('alert-custom-info').onclick = function () {
        Swal.fire({
            title: "Info Message",
            text: "Great Job!!",
            icon: "info"
    ...
    document.getElementById('alert-custom-question').onclick = function () {
        Swal.fire({
