            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 ...
                 <form method="POST" action="id_search_process_now.php" enctype="multipart/form-data" class="form-groups">
							<input type="text" name="up_userid" class="form-control" style="width:290px;" placeholder="Userid" required=""><br>
							<select id="cars" name="status" class="form-control" style="width:290px;" >
