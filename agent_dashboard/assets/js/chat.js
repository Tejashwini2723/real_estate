(function () {
    ...
    var myElement3 = document.getElementById('status-tab-pane');
    ...
    var myElement4 = document.getElementById('call-tab-pane');
    new SimpleBar(myElement4, { autoHide: true });
...
let changeTheInfo = (element, name, img, status) => {
    ...
    let image = `https://codeigniter.spruko.com/rixzo/rixzo/assets/images/faces/${img}.jpg`
...
new FgEmojiPicker({
    ...
    position: ['top', 'right'],
    preFetch: true,
    dir:"https://codeigniter.spruko.com/rixzo/rixzo/assets/libs/fg-emoji-picker/"
});
