            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Income Details</h6>
                 
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  
                 <form method="POST" action="income_search_process.php" enctype="multipart/form-data" class="form-groups">
