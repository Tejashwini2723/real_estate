               ...
               <div class="col-xl-12">
                  <div class="card custom-card">
                     <div class="card-body">
                        <div class="row mb-5">
                           <div class="col-xl-12">
                              <h5 class="fw-semibold text-center"> Blog </h5>
                              <br>
                           </div>
                           <div class="col-xl-12">
                                       ...
                                       <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                          <div class="card custom-card overflow-hidden">
                                             <div class="card-body bg-primary position-relative d-flex justify-content-center align-items-center">
                                                <?php 
                                                   $query1=mysqli_query($con,"SELECT * FROM `blog`");
                                                   $row1=mysqli_fetch_array($query1);
                                                    
                                                   if($row1['image']==NULL){
                                                      
                                                   ?> 
                                                <img src="../images/1.webp" class="img-fluid" style="max-width: 100%; height: auto; width: 300px; object-fit: cover;">
                                                <?php }else{
                                                   ?>   
                                                <img src="../admin/blog_image/<?php echo $row1['image'];?>" class="img-fluid" style="max-width: 100%; height: auto; width: 300px; object-fit: cover;">
                                                <?php
                                                   }?>
                                                <br>
                                             </div>
