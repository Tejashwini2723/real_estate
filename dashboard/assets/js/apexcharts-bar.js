(function () {
    ...
    var options = {
        ...
        colors: ["#8b7eff", "#35bdaa", "#ffb748", "#e6533c", "#49b6f5"],
        grid: {
            borderColor: '#f2f5f7',
        },
        title: {
    ...
    var options = {
        ...
        colors: ["#8b7eff", "#35bdaa", "#ffb748", "#e6533c", "#49b6f5", "#a65e76", "#5b67c7", "#a65e9a",
            "#26bf94", "#35bdaa"
        ],
        grid: {
            borderColor: '#f2f5f7',
    ...
    var options = {
        ...
        fill: {
            ...
            opacity: 0.87,
            image: {
                src: ['https://codeigniter.spruko.com/rixzo/rixzo/assets/images/media/media-64.jpg'],
                width: 466,
                height: 406
            }
        },
