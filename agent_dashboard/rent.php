               ...
               <div class="col-xl-12">
                  <div class="card custom-card">
                     <div class="card-body">
                        <div class="row mb-5">
                           <div class="col-xl-12">
                              <h5 class="fw-semibold text-center"> Buy Properties </h5><br>
                           </div>
                           <div class="col-xl-12">
                                 ...
                                 <div class="tab-pane show active p-0 border-0" id="pricing-monthly1-pane" role="tabpanel" aria-labelledby="pricing-monthly1" tabindex="0">
                                    <div class="row justify-content-center">
                                       ...
                                       <?php 
                                          ...
                                          // Fetch all properties from the 'sell' table
                                          $query = mysqli_query($con, "SELECT * FROM `sell`");
                                             ...
                                             <div class="card-body p-0">
                                                <div class="p-4">
                                                   <ul class="list-unstyled mb-0">
                                                      ...
                                                      <br><h5>Owner Contact Details</h5>
                                                      <li class="d-flex align-items-center mb-3">
                                                         <span class="me-2"><i class="fa-regular fa-circle-check fs-15 text-success"></i></span>
                                                      ...
                                                      <li class="d-grid">
                                                         <button class="btn btn-primary btn-wave">Buy Now</button>
                                                      </li>
                                                   </ul>
                                                </div>
                                             </div>
