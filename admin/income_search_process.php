              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
					...
					if(isset($_POST['add_product'])){
    					...
    					$query=mysqli_query($con,"SELECT * FROM `income` WHERE `userid`='$up_userid'");
    					...
    					$utitity_bill_wallet=$row['utitity_bill_wallet'];
    					}
						?>
                 <form method="POST" action="income_search_process_now.php" enctype="multipart/form-data" class="form-groups">
                     <input type="hidden" name="up_userid" class="form-control" style="width:290px;" value="<?php echo $up_userid?>" required="">
							...
							<input type="text" name="current_bal" class="form-control" style="width:290px;" value="<?php echo $current_bal?>" required=""><br>
							 <p>ROI</p>
							<input type="text" name="roi" class="form-control" style="width:290px;" value="<?php echo $roi?>" required=""><br>
							 <p>REFERRAL</p>
							<input type="text" name="referal_income" class="form-control" style="width:290px;" value="<?php echo $referal_income?>" required=""><br>
							 <p>BALANCE LOAN</p>
							<input type="text" name="bl_loan" class="form-control" style="width:290px;" value="<?php echo $bl_loan?>" required=""><br>
							 <p>Loan Amount</p>
							<input type="text" name="loan_amount" class="form-control" style="width:290px;" value="<?php echo $loan_amount?>" required=""><br>
							 <p>Cashback</p>
							<input type="text" name="cashback" class="form-control" style="width:290px;" value="<?php echo $cashback?>" required=""><br>
						<p>	utitity_bill_wallet</p>
						<input type="text" name="utitity_bill_wallet" class="form-control" style="width:290px;" value="<?php echo $utitity_bill_wallet?>" required=""><br>
