                ...
                <div class="col-lg-4 col-sm-6 col-12 mb-24" data-aos="fade-up" data-aos-duration="1000">
                    <div class="rx-rooms-main-box">
                        <div class="rooms-box-front">
                            <h3>Project Name: <?php echo $row['name']; ?></h3>
                            ...
                            ?>   
                                <img src="admin/project_image/<?php echo $row['image']; ?>" class="img-fluid" style="max-width: 100%; height: auto; width: 400px; object-fit: cover;">
                            <?php 
                                }
                            ?>
                            <br>
