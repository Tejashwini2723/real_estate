(function () {
    ...
    var options = {
        series: [{
            name: "Desktops",
            data: [20, 41, 30, 51, 50, 62, 32, 91, 125]
        }],
        chart: {
            height: 320,
            type: 'line',
    ...
    var options = {
        series: [
            {
                name: "High - 2013",
                data: [28, 39, 20, 46, 28, 48, 33]
            },
            {
                name: "Low - 2013",
                data: [22, 10, 24, 18, 27, 13, 23]
            }
        ],
        chart: {
            height: 320,
    ...
    var options = {
        ...
        annotations: {
            ...
            points: [{
                ...
                x: new Date('08 Dec 2023').getTime(),
                y: 9340.85,
                marker: {
                    size: 0
                },
                image: {
                    path: 'https://codeigniter.spruko.com/rixzo/rixzo/assets/images/faces/1.jpg'
                }
            }]
        },
        dataLabels: {
